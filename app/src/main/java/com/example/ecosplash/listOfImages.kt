...
fun fisbowlanimated(): List<Painter> {
    val imagenes = listOf(
        ...
        painterResource(id = R.drawable.p20),
        painterResource(id = R.drawable.p21),
        painterResource(id = R.drawable.p22),
        painterResource(id = R.drawable.p23),
        painterResource(id = R.drawable.p24),
        painterResource(id = R.drawable.p25),
        painterResource(id = R.drawable.p26),
        painterResource(id = R.drawable.p27),
        painterResource(id = R.drawable.p28),
        painterResource(id = R.drawable.p29),
        painterResource(id = R.drawable.p30),
        painterResource(id = R.drawable.p31),
        painterResource(id = R.drawable.p32),
        painterResource(id = R.drawable.p33),
        painterResource(id = R.drawable.p34),
        painterResource(id = R.drawable.p35),
        painterResource(id = R.drawable.p36),
        painterResource(id = R.drawable.p37),
        painterResource(id = R.drawable.p38)
    )
    return imagenes
}
